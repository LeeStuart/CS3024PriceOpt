...
//    private String freezerExp;
     ...
     * @param prices The price of the food.
     ...
     */
	public Food(int ID, String name, String unts, int amnt, double serving, double[] prices, double cal, double prot, double crbs, double sgrs, double ft, double sats, double fbr, double slt){
